...
CStdioFileEx::CStdioFileEx(LPCTSTR lpszFileName,UINT nOpenFlags):CStdioFile(lpszFileName, PreprocessFlags(lpszFileName, nOpenFlags))
{
}
...
UINT CStdioFileEx::PreprocessFlags(const CString& sFilePath, UINT& nOpenFlags)
{
   ...
   //如果要讀寫Unicode格式的文件,必須切換到typeBinary方式,因為這會影響fputws/fgetws的工作方式
   if (m_bIsUnicodeText)
   {
